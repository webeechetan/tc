...
const Impactoverview = () => {
  ...
  return (
    <DashboardCard title='Impact Overview'>
     <>
	    <Stack direction='row' spacing={4} alignItems='center'>
        <Box>
          <TypographyStyled variant='h6' marginBottom={1}>Recouped Amount</TypographyStyled>
          <Typography variant='h3' className='text-dark' >$ 1,280</Typography>
        </Box>
        <BarChart />
		</Stack>
