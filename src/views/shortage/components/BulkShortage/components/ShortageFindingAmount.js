...
const ShortageFindingAmount = () => {
  ...
  return (
    <DashboardCard title='Shortage Claim Finding'>
     <>
		...
		<Stack direction='row' spacing={4} useFlexGap marginTop={3}>
			<Box>
				<TypographyPayment  variant='h5'>Payment due date:</TypographyPayment>
...
export default ShortageFindingAmount;
